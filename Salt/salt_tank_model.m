function [Th,Tc,Vh,Vc] = run_salt_thermo(HXC,T_HL,T_CL,SALT)
...
events                  = [0 1 2 1 0 2 1 0]; % 0, 1 and 2 correspond to charge, store, and discharge, respectively
...
endt_event              = [1800 ...         % s             event 1 ends after 1800 s (30 minutes)
